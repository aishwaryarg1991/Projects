object LearningScala1 {
  ...
  val hello: String = "Holaaaaaaaa!"              //> hello  : String = Holaaaaaaaa!
  println(hello)                                  //> Holaaaaaaaa!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Holaaaaaaaa!
  helloThere = hello + " There!"
  println(helloThere)                             //> Holaaaaaaaa! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Holaaaaaaaa!There!
  println(immutableHelloThere)                    //> Holaaaaaaaa!There!
